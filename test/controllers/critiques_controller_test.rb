...
class CritiquesControllerTest < ActionController::TestCase
  ...
  test "should create critique" do
    assert_difference('Critique.count') do
      post :create, critique: { body: @critique.body, keypoint_id: @critique.keypoint_id, review_id: @critique.review_id, title: @critique.title, user_id: @critique.user_id }
    end
  ...
  test "should update critique" do
    patch :update, id: @critique, critique: { body: @critique.body, keypoint_id: @critique.keypoint_id, review_id: @critique.review_id, title: @critique.title, user_id: @critique.user_id }
    assert_redirected_to critique_path(assigns(:critique))
  end
